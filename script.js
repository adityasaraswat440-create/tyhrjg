...
document.addEventListener('DOMContentLoaded', () => {
  ...
  /* ------------------------------------------
     Author Description Popup
  ------------------------------------------ */
  const authorLink = document.getElementById('open-author-popup');
  const authorPopup = document.getElementById('author-popup');
  const closeAuthorBtn = document.getElementById('close-author-popup');

  if (authorLink && authorPopup) {
    authorLink.addEventListener('click', (e) => {
      e.preventDefault();
      authorPopup.classList.add('is-active');
    });

    closeAuthorBtn.addEventListener('click', () => {
      authorPopup.classList.remove('is-active');
    });
